...
function AllOrders() {
    ...
    const search = () => {
        ...
        const filteredBills = billDetail.filter(bill => {
            const lowerCaseValue = value.toLowerCase();
            const lowerCaseName = bill.account.name.toLowerCase();
            const lowerCasePhone = bill.account.phone.toLowerCase();
            return lowerCaseName.includes(lowerCaseValue) || lowerCasePhone.includes(lowerCaseValue);
        });
