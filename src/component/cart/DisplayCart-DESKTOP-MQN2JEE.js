                    ...
                    <div className="container">
                        <div className="title-cart">
                            <div className="header-item">
                                <div className="row">
                                    <div className="col-1"><input onClick={handleAllOrder} className="input-checkbox" id="checkbox-all" type="checkbox"/></div>
                                    ...
                                    <div className="header-item">
                                        <div className="row">
                                            <div className="col-1"><input className="input-checkbox"
                                                                          ...
                                                                          id={`checkbox-${cart.merchant.id_merchant}`} type="checkbox"/>
                                            </div>
                                            ...
                                            return (
                                                <div className="item-cart" key={count}>
                                                    <div className="row item">
                                                        <div className="col-1"><input className="input-checkbox"
                                                                                      type="checkbox" id={`checkbox-${cart.merchant.id_merchant}`}/></div>
